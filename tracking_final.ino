...
unsigned long ch_no = 11710866;//Replace with Thingspeak Channel number
const char * write_api = "SVRQM82XHVA6NTE";//Replace with Thingspeak write API
...
void displaydata()  //Ensure valid latitude and longitude and stored
